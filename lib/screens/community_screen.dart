      ...
      body: ListView(
        children: [
          ...
          kCommunityCard(
              title: '크림스프와 스튜의 중간쯤🥛',
              content:
                  '크림스튜 레시피를 보고 했긴한데 사랑니때문에 이가 아파서 재료를 좀 잘게 썰었더니 스프처럼 됐네요😆맛있으면 장땡!',
              imageUrl:
          ...
          kCommunityCard(
            title: '비빔만두🥟',
            content:
                '점심에도 만두먹고 저녁에도 만두먹는 만두광인..나야나..🤍 언제가 피드에서 보고 꼭 먹어야지 벼르고 있었는데 드디어! 만두 쪼오끔 탔지만 맛있게 잘 먹었습니다😆',
            imageUrl:
          ...
          kCommunityCard(
            title: '반미 샌드위치🥖',
            content:
                '재료가 많은가? 했는데 많으면 맛있지! 해서 다 쑤셔 넣었더니 완성된 욕망의 반미 샌드위치,,🥰 한 입에 들어가진 않지만 넘 맛있게 잘 먹었습니다😆',
            imageUrl:
